...
github_prefix="https://ghproxy.com/https://raw.githubusercontent.com/CokeMine/ServerStatus-Hotaru/master"
coding_prefix="https://ghproxy.com/https://cokemine.coding.net/p/hotarunet/d/ServerStatus-Hotaru/git/raw/master"
...
Download_Server_Status_server() {
  cd "/tmp" || exit 1
  [[ ${mirror_num} == 2 ]] && bundle_link="https://github.com.cnpmjs.org/CokeMine/ServerStatus-Hotaru/archive/master.zip" || bundle_link="https://ghproxy.com/https://github.com/CokeMine/ServerStatus-Hotaru/archive/master.zip"
  [[ ${mirror_num} == 2 ]] && github_link="https://github.com.cnpmjs.org/" || github_link="https://ghproxy.com/https://github.com"
...
Install_jq() {
  [[ ${mirror_num} == 2 ]] && {
    github_link="https://github.com.cnpmjs.org"
    raw_link="https://ghproxy.com/https://raw.githubusercontent.com"
  } || {
    github_link="https://ghproxy.com/https://github.com"
    raw_link="https://ghproxy.com/https://raw.githubusercontent.com"
  }
  if [[ ! -e ${jq_file} ]]; then
    if [[ ${bit} == "x86_64" ]]; then
...
Set_Mirror() {
  ...
  ${Green_font_prefix} 1.${Font_color_suffix} GitHub(已代理)
  ${Green_font_prefix} 2.${Font_color_suffix} Cnpmjs (部分资源通过 Cnpmjs 提供服务下载, Thanks to github.com.cnpmjs.org for the service)"
